...
namespace NorthWind.Core.Entities.Contracts.VacuumTruckFizContract
{
    [Table("VacuumTruckFizContract")]
    public class VacuumTruckFizContract : Contract, IEncryptObject
    {
